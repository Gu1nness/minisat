...
install-debug:	install-headers install-lib-debug install-bin-debug
...
install-bin-debug: $(BUILD_DIR)/debug/bin/$(MINISAT)
	$(INSTALL) -d $(DESTDIR)$(bindir)
	$(INSTALL) -m 755 $(BUILD_DIR)/debug/bin/$(MINISAT) $(DESTDIR)$(bindir)
